...
export default function About() {
  return (
    <div className="min-h-screen bg-background">
      <Header />
      <main>
        <section className="relative py-20 md:py-28 lg:py-32 overflow-hidden" style={{ backgroundColor: '#6ec5c6' }}>
          <motion.div 
            animate={{ 
              x: [0, 50, 0],
              y: [0, -30, 0],
          ...
          <div className="relative max-w-4xl mx-auto px-6 md:px-8 lg:px-12 text-center">
            <motion.h1 
              ...
              className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white"
            >
              Our Story
            </motion.h1>
            <motion.p 
            ...
            >
              {values.map((value, index) => (
                <motion.div key={index} variants={itemVariants}>
                  <Card className="p-8 text-center h-full" data-testid={`card-value-${index}`}>
                    <motion.div
              ...
              {timeline.map((item, index) => (
                ...
                >
                  <motion.div 
                    whileHover={{ y: -5 }}
                    transition={{ duration: 0.3 }}
                    className="bg-background rounded-xl p-6 h-full"
                  >
                    <motion.div
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
